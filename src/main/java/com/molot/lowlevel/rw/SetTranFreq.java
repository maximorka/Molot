...
public class SetTranFreq extends JDialog implements ByteDataListener {
    ...
    private JFormattedTextField txFreq;
    ...
    public static void main(String[] args) {
        try {
            SetTranFreq dialog = new SetTranFreq();
    ...
    public SetTranFreq() {
        ...
        JLabel lblIp = new JLabel("ПЧ ПРД:");

        txFreq = new JFormattedTextField();
        txFreq.setColumns(12);
        ...
        gl_contentPanel.setHorizontalGroup(
                gl_contentPanel.createParallelGroup(GroupLayout.Alignment.LEADING)
                        .addGroup(gl_contentPanel.createSequentialGroup()
                                ...
                                .addGroup(gl_contentPanel.createParallelGroup(GroupLayout.Alignment.LEADING)
                                        .addComponent(txFreq, GroupLayout.DEFAULT_SIZE, 347, Short.MAX_VALUE)
                                        )
                                .addContainerGap())
        );
                ...
                gl_contentPanel.createParallelGroup(GroupLayout.Alignment.LEADING)
                        .addGroup(gl_contentPanel.createSequentialGroup()
                                .addGroup(gl_contentPanel.createParallelGroup(GroupLayout.Alignment.BASELINE)
                                        .addComponent(lblIp)
                                        .addComponent(txFreq, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))
    ...
    class SaveListener implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            readerWriter.writeByteAsIs(Params.PROTOCOL.getByte("set-transmitter-frequency"));
            ...
            Params.SETTINGS.putString("tx_freq",freq);
...
//		portText.setText("");
    ...
    public void updateTextField() {
        ...
        String Freq = Params.SETTINGS.getString("tx_freq");
        txFreq.setValue(Freq);
    }
    @Override
